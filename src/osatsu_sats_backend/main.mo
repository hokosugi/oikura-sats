...
//     ],
// ]
  public func get_exchanges() : async Text {
    let bitcoin : Text = await get_bitcoin_exchange();
    let icp : Text = await get_icp_exchange();
    let data : Text = "#bitcoin#, #icp#";
    return data;
  };

  public func get_bitcoin_exchange() : async Text {
    ...
    let url = "https://api.coingecko.com/api/v3/simple/price?ids=bitcoin&vs_currencies=jpy%2Cusd%2Ceur&include_last_updated_at=true&precision=5";
  ...
  public func get_icp_exchange() : async Text {
    let ic : Types.IC = actor ("aaaaa-aa");
    let host : Text = "api.coingecko.com";
    let url = "https://api.coingecko.com/api/v3/simple/price?ids=internet-computer&vs_currencies=jpy%2Cusd%2Ceur&include_last_updated_at=true&precision=5";
    let request_headers = [
        { name = "Host"; value = host # ":443" },
        { name = "User-Agent"; value = "exchange_rate_canister" },
    ];
