...
const COINGECKO_URL = 'https://api.coingecko.com/api/v3/simple/price?ids=internet-computer&vs_currencies=jpy%2Cusd%2Ceur&include_last_updated_at=true&precision=5';
// Cache targets
const urlsToCache = [
//     './index.html',
//     './styles.css',
